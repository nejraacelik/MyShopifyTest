# shopifyTest
In this test I used Selenium Automation framework with C# in Chrome environment. For this packet I used nuget packege QATest.Setup which is also made by me.

This is made as initiliazation MyShopifyBaseTest
